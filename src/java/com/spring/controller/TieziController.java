...
public class TieziController extends BaseController
{
    ...
    public String getWhere()
    {
        ...
        // 以下也是一样的操作，判断是否符合条件，符合则写入sql 语句
            ...
            where += " AND jiajing ='"+Request.get("jiajing")+"' ";
        }
                if(!Request.get("zhiding").equals("")) {
            where += " AND zhiding ='"+Request.get("zhiding")+"' ";
        }
            return where;
    }
    ...
    */
    ...
    public String index()
    {
        String order = Request.get("order" , "zhiding");
    ...
    public String insert()
    {
        ...
        post.setHuifushu(Request.getInt("huifushu"));
        ...
        //插入 帖子 编号
        String res = String.format("T%5s", charuid);
        res = res.replaceAll("\\s", "0");
        Query.execute("UPDATE tiezi SET bianhao='" + res + "' WHERE id='" + charuid + "'");
    ...
    */
    ...
    public String update()
    {
        ...
        post.setDianjilv(Request.getInt("dianjilv"));
            if(!Request.get("huifushu").equals(""))
        post.setHuifushu(Request.getInt("huifushu"));
            if(!Request.get("jiajing").equals(""))
        post.setJiajing(Request.get("jiajing"));
                if(!Request.get("zhiding").equals(""))
    ...
    public String detailweb()
    {
        ...
        Query.execute("UPDATE tiezi SET dianjilv=dianjilv+1 WHERE id='"+request.getParameter("id")+"'");
    ...
    */
    ...
    public String delete()
    {
        ...
        HashMap delMap = Query.make("tiezi").find(id);
