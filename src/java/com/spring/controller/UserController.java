    ...
    protected String authLoginUser(boolean isAdmin,String username , String pwd,String cx)
    {
        ...
        if (cx.equals("用户")) {
            ...
            session.setAttribute("login" , cx);
                        ...
                        session.setAttribute("nicheng", user.getNicheng());
                        ...
                        session.setAttribute("gongzuoxingzhi", user.getGongzuoxingzhi());
                        session.setAttribute("gongzuodidian", user.getGongzuodidian());
                        session.setAttribute("gerenjianjie", user.getGerenjianjie());
                        session.setAttribute("jifen", user.getJifen());
