            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_jiajing13" data-value="${param.jiajing}" id="jiajing"
                                name="jiajing">
                            <option value="">请选择</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_zhiding14" data-value="${param.zhiding}" id="zhiding"
                                name="zhiding">
                            <option value="">请选择</option>
                            <option value="是">是</option>
                            <option value="否">否</option>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <c:set var="i" value="0"/><c:forEach items="${list}" var="map"><c:set var="i" value="${i+1}"/>
                        <tr id="${map.id}" pid="">
                            ...
                            <td> ${map.bianhao} </td>
                            <td> ${map.biaoti} </td>
                            <td><ssm:sql var="maplanmu3"
                                         type="find">SELECT lanmuming FROM lanmu where id='${map.lanmu}'</ssm:sql>${maplanmu3.lanmuming} </td>
                            <td><c:choose>
                            ...
                            <td align="center">
                                ...
                                <a href="jiajingzhiding_add.do?id=${map.id}">加精置顶</a>
