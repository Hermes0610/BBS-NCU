...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    ${readMap.xuqiubianhao}<input type="hidden" id="xuqiubianhao" name="xuqiubianhao" value="${Info.html(readMap.xuqiubianhao)}"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    ${readMap.jianglijifen}<input type="hidden" id="jianglijifen" name="jianglijifen" value="${Info.html(readMap.jianglijifen)}"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" id="huidaneirong" name="huidaneirong"></textarea>                                            
        </div>
    </div>
</div>
                                                                            <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="huidaren" name="huidaren" value="${sessionScope.username}"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
