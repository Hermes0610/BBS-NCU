...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <ssm:sql var="maplanmu13" type="find">SELECT lanmuming FROM lanmu where id='${readMap.lanmu}'</ssm:sql>${maplanmu13.lanmuming}<input type="hidden" id="lanmu" name="lanmu" value="${Info.html(readMap.lanmu)}"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
