...
<div class="panel panel-default">
    ...
    栏目
                            ...
                            <select class="form-control class_lanmu21" data-value="${param.lanmu}" id="lanmu" name="lanmu">
...
<script>
$(".class_lanmu21").val($(".class_lanmu21").attr("data-value"))</script>
...
<th> 回复人 </th>
                    ...
                    <tr id="${map.id}" pid="">
                        ...
                        <td> ${map.bianhao} </td>
<td> ${map.biaoti} </td>
<td> <ssm:sql var="maplanmu9" type="find">SELECT lanmuming FROM lanmu where id='${map.lanmu}'</ssm:sql>${maplanmu9.lanmuming} </td>
<td> ${map.faburen} </td>
<td> ${map.huifuren} </td>
