...
<c:when test="${'管理员' == sessionScope.cx }">
            ...
            <%@ include file="left_guanliyuan.jsp" %>
                        ...
                        <c:choose>
<c:when test="${'版主' == sessionScope.cx }">

            <%@ include file="left_banzhu.jsp" %>
            </c:when></c:choose>
                        <c:choose>
    ...
    <div class="container-fluid">
        <div class="header-logo">
            <a href="#">
                ...
                <span class="logo-text d-none d-lg-block">bbs论坛网站</span>
            </a>
        </div>
...
<c:when test="${sessionScope.touxiang != null && sessionScope.touxiang !=  '' }">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="logout.do" onclick="return confirm('确定退出系统？')" class="text-danger dropdown-item">退出登录</a>
                    </div>
                </li>
