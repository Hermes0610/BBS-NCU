...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" id="huidaneirong" name="huidaneirong">${Info.html(mmm.huidaneirong)}</textarea>                                            
        </div>
    </div>
</div>
                                                                            <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="huidaren" name="huidaren" value="${mmm.huidaren}"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
