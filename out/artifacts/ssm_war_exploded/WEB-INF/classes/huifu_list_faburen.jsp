...
<div class="panel panel-default">
    ...
    栏目
                            ...
                            <select class="form-control class_lanmu22" data-value="${param.lanmu}" id="lanmu" name="lanmu">
...
<script>
$(".class_lanmu22").val($(".class_lanmu22").attr("data-value"))</script>
...
<th> 回复人 </th>
                    ...
                    <tr id="${map.id}" pid="">
                        ...
                        <td> ${map.bianhao} </td>
<td> ${map.biaoti} </td>
<td> <ssm:sql var="maplanmu10" type="find">SELECT lanmuming FROM lanmu where id='${map.lanmu}'</ssm:sql>${maplanmu10.lanmuming} </td>
<td> ${map.faburen} </td>
<td> ${map.huifuren} </td>
