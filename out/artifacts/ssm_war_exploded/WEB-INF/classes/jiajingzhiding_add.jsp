...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_jiajing24" data-value="" id="jiajing" name="jiajing" style="width:250px">
...
<option value="是">是</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_zhiding25" data-value="" id="zhiding" name="zhiding" style="width:250px">
<option value="否">否</option>
<option value="是">是</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="caozuoren" name="caozuoren" value="${sessionScope.username}"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
