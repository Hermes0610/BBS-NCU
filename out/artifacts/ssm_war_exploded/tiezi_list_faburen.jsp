...
<div class="panel panel-default">
    ...
    栏目
                            ...
                            <select class="form-control class_lanmu15" data-value="${param.lanmu}" id="lanmu" name="lanmu">
...
<script>
$(".class_lanmu15").val($(".class_lanmu15").attr("data-value"))</script>
                        
</div>
                                                                                                                                                                    <div class="form-group">
    加精
    
                            <select class="form-control class_jiajing16" data-value="${param.jiajing}" id="jiajing" name="jiajing">
<option value="">请选择</option><option value="是">是</option>
<option value="否">否</option>

</select>
<script>
$(".class_jiajing16").val($(".class_jiajing16").attr("data-value"))</script>
                        
</div>
                                                                <div class="form-group">
    置顶
    
                            <select class="form-control class_zhiding17" data-value="${param.zhiding}" id="zhiding" name="zhiding">
<option value="">请选择</option><option value="是">是</option>
<option value="否">否</option>

</select>
<script>
$(".class_zhiding17").val($(".class_zhiding17").attr("data-value"))</script>
...
<th> 置顶 </th>
                    ...
                    <tr id="${map.id}" pid="">
                        ...
                        <td> ${map.bianhao} </td>
<td> ${map.biaoti} </td>
<td> <ssm:sql var="maplanmu4" type="find">SELECT lanmuming FROM lanmu where id='${map.lanmu}'</ssm:sql>${maplanmu4.lanmuming} </td>
<td> <c:choose>
