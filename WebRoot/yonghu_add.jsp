                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="form-control class_cx2" data-value="" id="cx" name="cx"
                                        style="width:250px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="password" class="form-control" style="width:150px;"
                                       data-rule-required="true" data-msg-required="请填写密码" id="pwd" name="pwd"
                                       value=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="form-control class_xingbie3" data-value="" id="xingbie" name="xingbie"
                                        style="width:250px">
