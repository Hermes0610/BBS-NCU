...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <ssm:sql var="maplanmu15" type="find">SELECT lanmuming FROM lanmu where id='${readMap.lanmu}'</ssm:sql>${maplanmu15.lanmuming}<input type="hidden" id="lanmu" name="lanmu" value="${Info.html(readMap.lanmu)}"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea style="width: 80%;height: 120px" class="form-control" id="huifuneirong" name="huifuneirong"></textarea>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="huifuren" name="huifuren" value="${sessionScope.username}"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
